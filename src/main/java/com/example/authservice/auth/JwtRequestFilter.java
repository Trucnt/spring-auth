...
/**
 * JwtRequestFilter class is executed for any incoming requests and validate JWT
 * from the request and sets it in the context to indicate that logged in user
 * is authenticated.
 */
@Component
